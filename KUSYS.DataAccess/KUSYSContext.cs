...
namespace KUSYS.DataAccess
{
    public class KUSYSContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-33LF6BM;Initial Catalog=KUSYSDB;user id=sa;password=1");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData
                ...
                new User() { UserId = 3, UserName = "aliyazar", Password = "ali", Name = "Ali", LastName = "Yazar", RoleId = 2,StudentId = 1 }
                );
